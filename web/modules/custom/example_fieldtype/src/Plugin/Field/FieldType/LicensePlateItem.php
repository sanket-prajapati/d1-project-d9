<?php
namespace Drupal\example_fieldtype\Plugin\Field\FieldType;
...
class LicensePlateItem extends FieldItemBase {
  ...
  */
  public function storageSettingsForm(array &$form,FormStateInterface $form_state, $has_data) {
    ...
    '#required' => TRUE,
    '#description' => $this->t('Maximum length for the plate
    code in characters.'),
    '#min' => 1,
    '#disabled' => $has_data,
    ];
 ...
 */
  ...
  */
  public function fieldSettingsForm(array $form, FormStateInterface $form_state) {
    ...
    a select list with license plate codes instead of a
    textfield, please provide the available codes. Each code
    on a new line.')
    ];
    return $element;
  }
